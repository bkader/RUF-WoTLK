...
local event_metatable = {__call = function(funcs, ...)
...
local self_metatable = {__call = function(funcs, self, ...)
...
listener:SetScript("OnEvent", function(self, event, ...) filter(...) end)
